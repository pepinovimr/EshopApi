...
namespace EshopApi.Migrations
{
    ...
    [Migration("20230428095135_1toNrev")]
    partial class _1toNrev
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EshopApi.Data.Model.PurchaseOrderItems", b =>
                {
                    ...
                    b.Property<int?>("PurchaseOrderHeadersId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PurchaseOrderHeadersId");
            ...
            modelBuilder.Entity("EshopApi.Data.Model.PurchaseOrderItems", b =>
                {
                    b.HasOne("EshopApi.Data.Model.PurchaseOrderHeaders", null)
                        .WithMany("PurchaseOrderItems")
                        .HasForeignKey("PurchaseOrderHeadersId");
                });
